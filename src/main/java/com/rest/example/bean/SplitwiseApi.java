...
public class SplitwiseApi extends DefaultApi10a {
    ...
    private static final String REQUEST_TOKEN_RESOURCE = BASE_URL + "/api/v3.0/get_request_token";
    private static final String ACCESS_TOKEN_RESOURCE = BASE_URL + "/api/v3.0/get_access_token";
